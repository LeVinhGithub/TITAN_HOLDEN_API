 ...
 * V3. Change new framework for easier maintenance process 01/12/18
 */
...
//All negative case
	...
	if(!(GlobalVariable.Glb_Dealer_Code == '299560')){
		CustomKeywords.'methodObject.ProcessService.validateInvalidDealerCode'(res_ProcessServiceVisit)
		}
	//Start Date is Past
